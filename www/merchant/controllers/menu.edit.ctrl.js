angular.module('merchantApp').controller('MenuEditController', ['$scope', 'merchantRESTSvc', 'toastr', 'WizardHandler', '$stateParams', '$state', '$timeout', '$q',
	function($scope, merchantRESTSvc, toastr, WizardHandler, $stateParams, $state, $timeout, $q) {
		$scope.menu = {
			status: 'draft',
			menu_description: []
		};
