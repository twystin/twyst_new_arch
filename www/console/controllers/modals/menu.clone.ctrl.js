angular.module('consoleApp').controller('MenuCloneController', function($scope, $modalInstance, menu_id, outlet_id, SweetAlert, consoleRESTSvc) {
    $scope.req_obj = {
        menu: menu_id
    };
    ...
    $scope.cloneMenu = function() {
        if (!$scope.req_obj.outlet) {
            ...
            consoleRESTSvc.cloneMenu(menu_id, $scope.req_obj.outlet).then(function(data) {
                $modalInstance.close();
            }, function(err) {
